...
ls School   # Lists the contents of the School directory to confirm that the files were moved there
ls   # Lists the files and directories in the current directory
mv animals.txt zoo.txt   # Renames the file animals.txt to zoo.txt in the same directory
ls   # Lists the files again to confirm that animals.txt was renamed to zoo.txt
